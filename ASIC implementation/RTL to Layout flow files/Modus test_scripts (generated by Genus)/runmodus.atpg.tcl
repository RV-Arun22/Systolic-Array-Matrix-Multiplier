...
build_model \
    ...
    -designsource	 $WORKDIR/accelerator.test_netlist.v \
...
build_testmode \
    -testmode	 FULLSCAN \
    -assignfile	 $WORKDIR/accelerator.FULLSCAN.pinassign \
    -modedef	 FULLSCAN \
...
check_log log_create_logic_tests_FULLSCAN_accelerator_atpg
...
#-------------------------------------------------------------------------------
write_vectors \
    -inexperiment	 accelerator_atpg \
    -testmode	 FULLSCAN \
    -language	 verilog \
    -scanformat	 parallel \

check_log log_write_vectors_FULLSCAN_accelerator_atpg
...
check_log log_commit_tests_FULLSCAN_accelerator_atpg
